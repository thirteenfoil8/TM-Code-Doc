# -*- coding: utf-8 -*-
#
# Mon premier document sphinx documentation build configuration file, created by
...
project = u"Création d'exercice"
copyright = u'2014, Florian Genilloud'
...
texinfo_documents = [
  ('index', 'Monpremierdocumentsphinx', u'Mon premier document sphinx Documentation',
   u'Florian', 'Monpremierdocumentsphinx', 'One line description of project.',
   'Miscellaneous'),
]
